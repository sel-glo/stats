...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'home', 'smartcleaners', 'sc-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'home', 'smartcleaners', 'sliced');
