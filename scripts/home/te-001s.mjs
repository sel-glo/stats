...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'home', 'textiles', 'te-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'home', 'textiles', 'sliced');
