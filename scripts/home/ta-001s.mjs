...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'home', 'tableware', 'ta-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'home', 'tableware', 'sliced');
