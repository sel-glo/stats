...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'home', 'cookware', 'co-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'home', 'cookware', 'sliced');
