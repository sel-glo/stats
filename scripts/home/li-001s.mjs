...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'home', 'lighting', 'li-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'home', 'lighting', 'sliced');
