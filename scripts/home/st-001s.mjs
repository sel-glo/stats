...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'home', 'storage', 'st-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'home', 'storage', 'sliced');
