...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'home', 'kitchentools', 'kt-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'home', 'kitchentools', 'sliced');
