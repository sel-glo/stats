...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'home', 'digitalgadgets', 'dg-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'home', 'digitalgadgets', 'sliced');
