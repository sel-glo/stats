...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'home', 'homeother', 'hoo-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'home', 'homeother', 'sliced');
