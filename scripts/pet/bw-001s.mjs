...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'pet', 'bowlsfeeders', 'bw-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'pet', 'bowlsfeeders', 'sliced');
