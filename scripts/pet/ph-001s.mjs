...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'pet', 'pethygiene', 'ph-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'pet', 'pethygiene', 'sliced');
