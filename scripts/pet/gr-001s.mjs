...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'pet', 'grooming', 'gr-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'pet', 'grooming', 'sliced');
