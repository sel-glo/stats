...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'pet', 'bedshouses', 'bh-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'pet', 'bedshouses', 'sliced');
