...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'pet', 'petother', 'peo-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'pet', 'petother', 'sliced');
