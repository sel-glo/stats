...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'vehicles', 'motorcycle', 'mt-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'vehicles', 'motorcycle', 'sliced');
