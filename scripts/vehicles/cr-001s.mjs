...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'vehicles', 'car', 'cr-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'vehicles', 'car', 'sliced');
