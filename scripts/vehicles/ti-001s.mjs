...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'vehicles', 'tires', 'ti-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'vehicles', 'tires', 'sliced');
