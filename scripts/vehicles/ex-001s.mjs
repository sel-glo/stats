...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'vehicles', 'exteriorparts', 'ex-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'vehicles', 'exteriorparts', 'sliced');
