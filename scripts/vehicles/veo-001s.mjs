...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'vehicles', 'vehiclesother', 'veo-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'vehicles', 'vehiclesother', 'sliced');
