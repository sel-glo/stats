...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'vehicles', 'interiorparts', 'in-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'vehicles', 'interiorparts', 'sliced');
