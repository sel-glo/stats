...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'vehicles', 'scooters', 'so-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'vehicles', 'scooters', 'sliced');
