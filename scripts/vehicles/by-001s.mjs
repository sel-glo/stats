...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'vehicles', 'bicycle', 'by-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'vehicles', 'bicycle', 'sliced');
