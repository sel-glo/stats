...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'food', 'juices', 'ju-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'food', 'juices', 'sliced');
