...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'food', 'spices', 'sp-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'food', 'spices', 'sliced');
