...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'food', 'sweets', 'sw-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'food', 'sweets', 'sliced');
