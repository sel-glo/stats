...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'food', 'nutsfruits', 'nu-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'food', 'nutsfruits', 'sliced');
