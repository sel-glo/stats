...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'food', 'snacksstreet', 'sn-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'food', 'snacksstreet', 'sliced');
