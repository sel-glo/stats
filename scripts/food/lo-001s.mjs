...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'food', 'localtrad', 'lo-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'food', 'localtrad', 'sliced');
