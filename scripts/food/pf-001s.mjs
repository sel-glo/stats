...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'food', 'picklesferments', 'pf-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'food', 'picklesferments', 'sliced');
