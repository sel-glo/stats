...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'food', 'foodother', 'foo-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'food', 'foodother', 'sliced');
