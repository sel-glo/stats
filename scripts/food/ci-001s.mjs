...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'food', 'cookingredients', 'ci-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'food', 'cookingredients', 'sliced');
