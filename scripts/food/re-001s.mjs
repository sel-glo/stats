...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'food', 'restaurants', 're-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'food', 'restaurants', 'sliced');
