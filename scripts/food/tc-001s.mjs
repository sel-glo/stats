...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'food', 'teacoffee', 'tc-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'food', 'teacoffee', 'sliced');
