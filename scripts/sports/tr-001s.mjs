...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'sports', 'travel', 'tr-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'sports', 'travel', 'sliced');
