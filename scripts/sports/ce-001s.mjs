...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'sports', 'campingequipment', 'ce-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'sports', 'campingequipment', 'sliced');
