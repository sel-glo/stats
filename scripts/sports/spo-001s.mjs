...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'sports', 'sportsother', 'spo-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'sports', 'sportsother', 'sliced');
