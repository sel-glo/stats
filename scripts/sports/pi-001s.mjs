...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'sports', 'picnic', 'pi-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'sports', 'picnic', 'sliced');
