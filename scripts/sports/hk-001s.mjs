...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'sports', 'hiking', 'hk-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'sports', 'hiking', 'sliced');
