...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'sports', 'swimbeach', 'sb-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'sports', 'swimbeach', 'sliced');
