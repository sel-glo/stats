...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'sports', 'fitness', 'fi-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'sports', 'fitness', 'sliced');
