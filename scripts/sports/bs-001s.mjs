...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'sports', 'bicyclesscooters', 'bs-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'sports', 'bicyclesscooters', 'sliced');
