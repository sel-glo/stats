// scripts/electronics/mo-001s.mjs
import fs from 'fs';
...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'electronics', 'mobile', 'mo-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'electronics', 'mobile', 'sliced');
