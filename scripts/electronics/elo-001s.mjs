// scripts/electronics/elo-001s.mjs
import fs from 'fs';
...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'electronics', 'electronicsother', 'elo-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'electronics', 'electronicsother', 'sliced');

// ===== تنظیمات (پیکسل واقعی تصویر) =====
const startX_px = 15;    // شروع برش از لبه چپ (px)
const endX_px   = 495;  // پایان برش (px)
