// scripts/electronics/he-001s.mjs
import fs from 'fs';
...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'electronics', 'headphones', 'he-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'electronics', 'headphones', 'sliced');
