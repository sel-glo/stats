// scripts/electronics/sm-001s.mjs
import fs from 'fs';
...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'electronics', 'smartwatches', 'sm-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'electronics', 'smartwatches', 'sliced');
