...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'tools', 'electricalsupplies', 'ee-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'tools', 'electricalsupplies', 'sliced');
