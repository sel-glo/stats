...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'tools', 'building', 'bu-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'tools', 'building', 'sliced');
