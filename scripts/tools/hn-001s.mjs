...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'tools', 'handtools', 'hn-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'tools', 'handtools', 'sliced');
