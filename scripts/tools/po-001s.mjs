...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'tools', 'powertools', 'po-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'tools', 'powertools', 'sliced');
