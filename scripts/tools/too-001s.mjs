...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'tools', 'toolsother', 'too-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'tools', 'toolsother', 'sliced');
