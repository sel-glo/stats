...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'tools', 'plumbing', 'pl-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'tools', 'plumbing', 'sliced');
