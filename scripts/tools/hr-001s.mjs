...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'tools', 'hardware', 'hr-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'tools', 'hardware', 'sliced');
