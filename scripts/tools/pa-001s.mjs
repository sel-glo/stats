...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'tools', 'paintcoatings', 'pa-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'tools', 'paintcoatings', 'sliced');
