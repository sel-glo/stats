...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'beauty', 'beautyother', 'beo-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'beauty', 'beautyother', 'sliced');
