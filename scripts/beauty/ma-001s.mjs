...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'beauty', 'makeup', 'ma-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'beauty', 'makeup', 'sliced');
