...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'beauty', 'bodycare', 'bo-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'beauty', 'bodycare', 'sliced');
