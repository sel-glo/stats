...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'beauty', 'perfume', 'pe-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'beauty', 'perfume', 'sliced');
