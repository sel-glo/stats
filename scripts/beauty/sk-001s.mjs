...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'beauty', 'skincare', 'sk-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'beauty', 'skincare', 'sliced');
