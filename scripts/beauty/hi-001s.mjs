...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'beauty', 'haircare', 'hi-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'beauty', 'haircare', 'sliced');
