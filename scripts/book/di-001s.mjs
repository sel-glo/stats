...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'book', 'diykits', 'di-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'book', 'diykits', 'sliced');
