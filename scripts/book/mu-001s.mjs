...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'book', 'musical', 'mu-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'book', 'musical', 'sliced');
