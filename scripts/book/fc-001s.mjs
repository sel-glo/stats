...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'book', 'fiction', 'fc-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'book', 'fiction', 'sliced');
