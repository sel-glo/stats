...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'book', 'childrensbooks', 'cb-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'book', 'childrensbooks', 'sliced');
