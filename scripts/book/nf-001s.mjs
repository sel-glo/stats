...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'book', 'nonfiction', 'nf-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'book', 'nonfiction', 'sliced');
