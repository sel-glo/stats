...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'book', 'bookother', 'boo-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'book', 'bookother', 'sliced');
