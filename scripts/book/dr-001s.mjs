...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'book', 'drawing', 'dr-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'book', 'drawing', 'sliced');
