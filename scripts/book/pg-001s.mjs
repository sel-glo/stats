...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'book', 'painting', 'pg-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'book', 'painting', 'sliced');
