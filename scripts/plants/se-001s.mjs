...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'plants', 'seeds', 'se-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'plants', 'seeds', 'sliced');
