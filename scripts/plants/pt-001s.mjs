...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'plants', 'pots', 'pt-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'plants', 'pots', 'sliced');
