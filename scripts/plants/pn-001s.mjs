...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'plants', 'plantdecor', 'pn-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'plants', 'plantdecor', 'sliced');
