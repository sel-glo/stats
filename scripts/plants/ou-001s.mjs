...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'plants', 'outdoorplants', 'ou-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'plants', 'outdoorplants', 'sliced');
