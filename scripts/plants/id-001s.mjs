...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'plants', 'indoorplants', 'id-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'plants', 'indoorplants', 'sliced');
