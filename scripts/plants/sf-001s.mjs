...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'plants', 'soilfertilizer', 'sf-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'plants', 'soilfertilizer', 'sliced');
