...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'plants', 'plantsother', 'plo-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'plants', 'plantsother', 'sliced');
