...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'plants', 'gardening', 'ga-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'plants', 'gardening', 'sliced');
