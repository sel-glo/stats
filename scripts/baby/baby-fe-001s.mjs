...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'baby', 'feedingsupplies', 'fe-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'baby', 'feedingsupplies', 'sliced');
