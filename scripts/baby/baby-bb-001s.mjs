...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'baby', 'babyclothing', 'bb-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'baby', 'babyclothing', 'sliced');
