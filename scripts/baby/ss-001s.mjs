...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'baby', 'strollers', 'ss-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'baby', 'strollers', 'sliced');
