...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'baby', 'babycare', 'bc-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'baby', 'babycare', 'sliced');
