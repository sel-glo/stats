...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'baby', 'schoolbags', 'sg-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'baby', 'schoolbags', 'sliced');
