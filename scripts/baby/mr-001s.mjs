...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'baby', 'maternitywear', 'mr-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'baby', 'maternitywear', 'sliced');
