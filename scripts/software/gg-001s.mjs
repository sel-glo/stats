...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'software', 'gaming', 'gg-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'software', 'gaming', 'sliced');
