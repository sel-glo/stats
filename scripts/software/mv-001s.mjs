...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'software', 'moviesmusic', 'mv-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'software', 'moviesmusic', 'sliced');
