...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'software', 'softwareother', 'soo-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'software', 'softwareother', 'sliced');
