...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'software', 'softwarelicenses', 'sl-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'software', 'softwarelicenses', 'sliced');
