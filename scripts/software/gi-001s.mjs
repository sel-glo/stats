...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'software', 'giftcards', 'gi-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'software', 'giftcards', 'sliced');
