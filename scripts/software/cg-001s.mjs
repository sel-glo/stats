...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'software', 'consolegames', 'cg-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'software', 'consolegames', 'sliced');
