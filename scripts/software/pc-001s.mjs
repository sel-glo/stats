...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'software', 'pcgames', 'pc-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'software', 'pcgames', 'sliced');
