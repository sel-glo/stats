...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'software', 'mobileapps', 'mb-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'software', 'mobileapps', 'sliced');
