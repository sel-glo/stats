...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'clothing', 'sunglasses', 'su-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'clothing', 'sunglasses', 'sliced');
