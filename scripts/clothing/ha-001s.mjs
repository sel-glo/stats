...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'clothingother', 'hats', 'ha-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'clothingother', 'hats', 'sliced');
