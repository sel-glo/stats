...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'clothing', 'men', 'me-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'clothing', 'men', 'sliced');
