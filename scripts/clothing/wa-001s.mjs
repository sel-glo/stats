...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'clothing', 'watches', 'wa-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'clothing', 'watches', 'sliced');
