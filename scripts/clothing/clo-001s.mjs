...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'clothing', 'clothingother', 'clo-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'clothing', 'clothingother', 'sliced');
