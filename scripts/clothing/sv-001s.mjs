...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'clothing', 'scarves', 'sv-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'clothing', 'scarves', 'sliced');
