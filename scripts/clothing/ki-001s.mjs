...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'clothing', 'kids', 'ki-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'clothing', 'kids', 'sliced');
