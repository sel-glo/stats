...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'clothing', 'bags', 'ba-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'clothing', 'bags', 'sliced');
