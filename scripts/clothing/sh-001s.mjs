...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'clothing', 'shoes', 'sh-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'clothing', 'shoes', 'sliced');
