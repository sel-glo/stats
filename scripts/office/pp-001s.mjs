...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'office', 'penspencils', 'pp-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'office', 'penspencils', 'sliced');
