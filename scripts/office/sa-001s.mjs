...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'office', 'stationery', 'sa-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'office', 'stationery', 'sliced');
