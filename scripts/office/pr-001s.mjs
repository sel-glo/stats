...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'office', 'printers', 'pr-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'office', 'printers', 'sliced');
