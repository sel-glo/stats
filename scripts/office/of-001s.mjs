...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'office', 'officesupplies', 'of-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'office', 'officesupplies', 'sliced');
