...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'office', 'notebooks', 'no-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'office', 'notebooks', 'sliced');
