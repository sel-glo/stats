...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'office', 'deskschairs', 'dc-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'office', 'deskschairs', 'sliced');
