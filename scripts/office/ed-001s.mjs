...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'office', 'educational', 'ed-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'office', 'educational', 'sliced');
