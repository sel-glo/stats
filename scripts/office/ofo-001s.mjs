...
const INPUT_PATH = path.join(__dirname, '..', '..', 'daily', 'office', 'officeother', 'ofo-001.png');
const OUTPUT_DIR = path.join(__dirname, '..', '..', 'daily', 'office', 'officeother', 'sliced');
